...
class DataModelGenerator:
    ...
    def _get_python_type(self, field: SchemaField) -> Type:
        ...
        # Simple types - default to str for XSD compatibility
        type_mapping = {
            DataType.STRING: str,
            DataType.INTEGER: str,  # XSD integers are often strings
            DataType.DECIMAL: str,  # XSD decimals are often strings
